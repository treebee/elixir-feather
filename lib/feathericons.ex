defmodule Feathericons.Compiler do
  ...
  def generate_function(path, default_attrs) do
    ...
    {_, body} = String.split_at(icon, i + 1)
    ...
    quote do
      ...
      def unquote(name)(opts \\ []) do
        ...
        opts = Keyword.delete(opts, :title)
        ...
        title =
          if title == "" do
            ...
            ["<title>", Phoenix.HTML.Safe.to_iodata(title), "</title>"]
          end
        ...
        {:safe, ["<svg", Phoenix.HTML.Safe.to_iodata(attrs), ">", title, unquote(body)]}
      end
    end
  end
end
